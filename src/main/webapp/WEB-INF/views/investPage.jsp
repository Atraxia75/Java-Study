...
<title>크라우드펀딩 | 크라우디</title>
	...
	content="https://www.ycrowdy.com/mypage/main">
	...
	<link href="/resources/font/NotoSansCJKkr/font.min.css"
	rel="stylesheet">
	...
	<link rel="stylesheet"
	href="./resources/crowdyCss/common.min.css">
	<link rel="stylesheet"
	href="./resources/crowdyCss/theme.min.css">
    <link rel="stylesheet"
	href="./resources/crowdyCss/custom.min.css">
    
    <link rel="stylesheet"
	href="./resources/crowdyCss/crowdy/crowdy.min.css">
    <link rel="stylesheet"
	href="./resources/crowdyCss/crowdy/crowdyCardUI.min.css">
    <link rel="stylesheet"
...
<script
	src="https://connect.facebook.net/ko_KR/sdk.js?hash=f972a75032919f7c581f55fae2b9cde5&amp;ua=modern_es6"
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/882224542/?random=1593596547822&amp;cv=9&amp;fst=1593596547822&amp;num=1&amp;label=NYTuCI7MmWwQntvWpAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=15&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6o0&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.ycrowdy.com%2Fmypage%2Fmain%3Fmenu%3D1&amp;ref=https%3A%2F%2Fwww.ycrowdy.com%2F&amp;tiba=%ED%81%AC%EB%9D%BC%EC%9A%B0%EB%93%9C%ED%8E%80%EB%94%A9%20%7C%20%ED%81%AC%EB%9D%BC%EC%9A%B0%EB%94%94&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<style type="text/css">
.fb_hidden {
	position: absolute;
	top: -10000px;
...
<body class="detail-wrapper2">
	...
	<link href="./resources/dropify/dropify.css" rel="stylesheet">


	<link rel="stylesheet" href="./resources/crowdyCss/custom_shinhan.min.css">


	<link href="https://cdn.rawgit.com/noppa/text-security/master/dist/text-security.css"
	...
	<script
		src="./rescources/crowdyJs/customer.script.min.js"></script>
	<script
	...
	<script	src="./resources/crowdyJs/component_common.js"></script>


	<script	src="./resources/crowdyJs/component_mypage.js"></script>
				...
				<div id="list_wrap" class="common_vi_wrap common_vi_wrap6">
					...
					<div class="webfont2 visible-xs-block pl20 pr20">
						...
						<div class="common_block_box">
							<div class="font18">
								<span class="blue-800">전정민</span>님
							</div>
							<div class="font15">clover2745@nate.com</div>
						</div>
					</div>
				</div>
				<div class="common_sub_layout">
					<div id="list_category" class="common_sub_top_menu_1">
						<div class="common_sub_top_menu webfont2">
							<div class="container">
								<a href="javascript:void(0)" class="active"><span
...
<!-- 페이지 왼쪽 메뉴들 -->								
								<div class="st-menu webfont2">
									<ul>
										<li class="w30 active"><a href="javascript:void(0)">리워드</a></li>
										<li class="w30"><a href="javascript:void(0)">투자</a></li>
										<li class="w40"><a href="javascript:void(0)">모의펀딩</a></li>
									</ul>
										...
										<div>
											<nav class="text-center mt30 mb20">
												<ul data-v-82963a40="" class="pagination">
													<!---->
													<li data-v-82963a40="" class="disabled"><a
														data-v-82963a40="" tabindex="0">Prev</a></li>
													<li data-v-82963a40="" class="disabled"><a
														data-v-82963a40="" tabindex="0">Next</a></li>
													<!---->
												</ul>
											</nav>
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<div class="row row-mobile-n">
																<a data-dismiss="modal" class="modalBlueBtn">아니오</a> <a
																	class="ml30 pointerCursor">예</a>
															</div>
														</div>
													</div>
												</div>
											</div>
											<div id="deliveryNModal" tabindex="-1" role="dialog"
												class="modal fade">
												<div role="document" class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-body modal-order">
															프로젝트가 종료되어 배송지 변경은 <br> 제작자에게 직접 연락을 통해서만 가능합니다.
											...
											<div id="deliveryModal" tabindex="-1" role="dialog"
												data-backdrop="static" data-keyboard="false"
												class="modal fade" style="overflow-y: scroll;">
														...
														<div class="modal-body">
															<form action="#" class="form-horizontal">
																<div class="pay_info_wrap">
																	<div class="step-title">배송정보 입력</div>
																	<div class="row row-mobile-n">
																		<div class="col-sm-5">
																			<div class="form-group row-mobile-n">
																				<label for="delivery_mobile"
																					class="col-xs-12 control-label"><div
																						class="text-left">받는 사람 휴대폰 번호</div></label>
																				<div class="col-sm-12">
																					<div class="row row-mobile-n">
																						<div class="col-xs-12">
																							<input type="text" autocomplete="new-password"
																								pattern="[0-9]*" inputmode="numeric"
																								maxlength="11" data-vv-name="spsRsMobileNo"
																								class="form-control">
																							<!---->
																						</div>
																					</div>
																					<label for="delivery_person_check"
																						class="checkbox-inline"><input
																						type="checkbox"><span class="label"></span><span
																						class="label-text">회원 정보와 동일</span></label>
																				</div>
																			</div>
																		</div>
																		<div class="col-sm-7">
																			<div class="form-group mb10 row-mobile-n">
																				<label for="delivery_person"
																					class="col-xs-12 control-label"><div
																						class="text-left">받는 사람</div></label>
																				<div class="col-sm-12">
																					<input data-vv-name="spsRsName"
																						placeholder="반드시 실명을 입력해주세요" class="form-control"
																	...
																	<div class="form-group row-mobile-n">
																		<label for="zip_code" class="col-xs-12 control-label"><div
																				class="text-left">우편번호</div></label>
																		<div class="col-sm-6">
																			<div class="input-group input-group-file">
																				<input data-vv-name="postNum" readonly="readonly"
																					class="form-control" aria-required="true"
																					aria-invalid="false">
																				<!---->
																				<span class="input-group-btn"><span
																					class="btn btn-outline btn-file"><i
																						aria-hidden="true" class="fa fa-upload"></i></span></span>
																			</div>
																		</div>
																	</div>
																	<div class="form-group row-mobile-n">
																		<label for="address1" class="col-xs-12 control-label"><div
																				class="text-left">주소</div></label>
																		<div class="col-xs-12 mb10">
																			<input type="text" data-vv-name="address1"
																		...
																		<div class="col-xs-12">
																			<input type="text" data-vv-name="spsAddr2"
																	...
																	<div class="form-group mb0 row-mobile-n">
																		<label for="delivery_person"
																			class="col-xs-12 control-label"><div
																				class="text-left">진행자에게 요청사항</div></label>
																		<div class="col-sm-12">
														...
														<div class="modal-footer">
															<div class="row row-mobile-n">
																<a data-dismiss="modal" class="pointerCursor">취소</a> <a
																	class="ml30 modalBlueBtn">배송지 변경</a>
															</div>
														</div>
													</div>
												</div>
											</div>
											<div id="trackerModal" tabindex="-1" role="dialog"
												data-backdrop="static" data-keyboard="false"
												class="modal fade in deliveryModal">
												<div role="document" class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<div style="width: 70px;">배송 조회</div>
															<button type="button" data-dismiss="modal"
																aria-label="Close" class="xButton"></button>
														</div>
														<!---->
													</div>
												</div>
		...
		<script>
			//<![CDATA[
				$(document).scroll(function () {
					...
					if (scroll > listWrap.top) gnb.addClass('navbar-fixed-up');
					else gnb.removeClass('navbar-fixed-up');
				...
				var dictionary = {
					en: {
						messages: {
							required: function(field) { return "해당 정보를 입력해주세요."; }
						}
					}
				};
				...
				new Vue({
					...
					computed : {
						...
						subMenu : function() {
							return new URLSearchParams(window.location.search).get("sub-menu") ? new URLSearchParams(window.location.search).get("sub-menu") : "1";
						},
						accountMenu : function() {
							return new URLSearchParams(window.location.search).get("account-menu") ? new URLSearchParams(window.location.search).get("account-menu") : "0";
						}
					}
				});
			//]]>
  ...
  (function() {
    ...
    if (document.readyState === 'complete') {
      ...
      window.addEventListener('load', l, false);
		...
		<div aria-hidden="true" aria-labelledby="evaluation-write"
			id="pop-postcode" role="dialog" tabindex="-1" class="modal fade"
	...
	var post = new Vue({
		...
		methods : {
			open : function(component) {
				...
				$('#pop-postcode').modal({backdrop: 'static', keyboard: false});
				new daum.Postcode({
					theme: self.themeObj,
